def generate_report(target_url: str, findings: list[dict], overall_rating: str) -> str:
    ...
    if not risky:
        return f"MORTIS completed a baseline scan of {target_url}. No major issues were identified during this limited MVP 
scan. Further authenticated and deeper testing is still recommended."
    ...
    lines.append("This report is an initial draft and should be reviewed by a human tester before being used in a formal 
